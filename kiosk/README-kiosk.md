...
| 項目 | 要求 | 怎麼確認 |
|---|---|---|
| 作業系統 | **Win10**（已改裝，2026-08-21） | 「我的電腦」右鍵 → 內容 |
| .NET Framework | Win10 內建 4.8（TLS 1.2 沒問題） | 控制台 → 解除安裝程式 |
| 瀏覽器 | **Chrome 最新版**（Win10 無 109 限制） | chrome://version |
